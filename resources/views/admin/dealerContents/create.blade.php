    ...
    <section class="content">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <a href="{{ route('admin.dealerContents.index') }}" title="@lang('messages.back')"
                       class="btn btn-warning btn-sm mb-3">
                        <i class="fa fa-arrow-left" aria-hidden="true"></i>
                        @lang('messages.back')
                    </a>
                    <div class="info-box flex-column shadow-none">
                        <form method="POST" action="{{ route('admin.dealerContents.store') }}" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            @include('admin.dealerContents._form')
                        </form>
                    </div>
                </div>
            </div>
