            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="info-box flex-column shadow-none">
                        <form method="POST"
                              action="{{ route('admin.categories.updateSeo', ['category' => $category]) }}">
                            @csrf
                            @method('PATCH')
                                        ...
                                        @forelse(\App\Models\Translate::LANGUAGES_ASSOC as $key => $language)
                                            <div class="tab-pane fade @if($loop->first) active in show @endif"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    >{{ isset($category) ? $category->metaTitleTranslate?->{$key} : (old('meta_title.'.$key) ?? '') }}</textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    >{{ isset($category) ? $category->metaDescriptionTranslate?->{$key} : (old('meta_description.'.$key) ?? '') }}</textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    >{{ isset($category) ? $category->metaKeywordTranslate?->{$key} : (old('meta_keyword.'.$key) ?? '') }}</textarea>
