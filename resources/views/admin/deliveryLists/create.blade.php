            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="info-box flex-column shadow-none">
                        <form method="POST" action="{{ route('admin.deliveryLists.store') }}" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            @include('admin.deliveryLists._form')
                        </form>
                    </div>
                </div>
            </div>
...
@push('scripts')
    ...
    @includeIf('admin._components.ckeditor4Scripts', ['height' => 100])
@endpush
