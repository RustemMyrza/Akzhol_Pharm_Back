...
return [
    ...
    'attributes' => [
        ...
        'icon' => 'Белгіше',
        'icon_size' => 'Белгіше (Макс: :size Мб)',
        'link' => 'Сілтеме',
        'cookie_text' => 'Cookie мәтіні',
        'email_icon' => 'Электрондық пошта белгішесі',
        'phone_icon' => ' Телефон белгішесі ',
        'created_at' => 'Тіркелген күні',
        'role' => 'Рөл',
        'fio' => 'ФИО',
        'image' => 'Сурет',
        'image_size' => 'Сурет (Макс: :size Мб)',
        'image_desktop_size' => 'Сурет Desktop (Макс: :size Мб)',
        'image_mobile_size' => 'Сурет Mobile (Макс: :size Мб)',
        'position' => 'Реті',
        'address' => 'Мекенжай',
